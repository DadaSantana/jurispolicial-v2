...
export async function POST(request: any) {
    try {
        ...
        // Configuração do plano teste
        const planConfig = PLAN_TO_ASAAS_CONFIG.teste;
        const planType = 'teste';

        // Calcular data do próximo vencimento (1 dia a partir de hoje para teste)
