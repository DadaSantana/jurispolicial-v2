...
export async function POST(request: any) {
    try {
        ...
        // Configuração do plano semestral
        const planConfig = PLAN_TO_ASAAS_CONFIG.semestral;
        const planType = 'semestral';

        // Calcular data do próximo vencimento (180 dias a partir de hoje)
