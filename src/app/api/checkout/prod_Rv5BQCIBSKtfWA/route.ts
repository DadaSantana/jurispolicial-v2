...
export async function POST(request: any) {
    try {
        ...
        // Configuração do plano trimestral
        const planConfig = PLAN_TO_ASAAS_CONFIG.trimestral;
        const planType = 'trimestral';

        // Calcular data do próximo vencimento (90 dias a partir de hoje)
